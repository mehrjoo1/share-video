...
<body>
    ...
    <div class="site-output">
        <div id="all-output" class="col-md-12">
            {{-- {{ $content }}: ارث بری با کامپوننت --}}
            {{-- {{ $content }}: با این مشخص میکنید که کدوم قسمت رو میخواهید گسترش دهید --}}
            {{-- <x-layout><x-slot name="content"></x-slot></x-layout>: این قسمت رو توی صفحه ای که میخواهید از این صفحه ارث بری کنه بیارید و محتوا رو داخل تگ اسلات بزارید--}}
            {{-- <x-layout></x-layout>: این خط کد رو فقط نوشتم که بدونید چیه .و چجوری باید ازش استفاده کرد --}}
            {{ $content ?? '' }}
        </div>
    </div>
